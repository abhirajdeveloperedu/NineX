...
const CONFIG = {
    ...
    PAYMENT: {
        // Payment calculation: Per credit = ₹75
        PRICE_PER_CREDIT: 75,
        // Package pricing
        PACKAGES: {
            '240': { credits: 1, price: 75 },    // 10 days = 1 credit = ₹75
            '480': { credits: 2, price: 150 },   // 20 days = 2 credits = ₹150
            '720': { credits: 3, price: 225 }    // 30 days = 3 credits = ₹225
        }
    }
};
